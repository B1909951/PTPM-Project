...
public class SinhVien {
	...
	public void xoahp(String ten){
		...
		if(check == 0) {
			System.out.println("Sinh vien khong co hoc phan nay!!!");
			return;
		}
		if(i!=sl) {
		...
		System.out.println("Xoa hoc phan " + ten + " thanh cong!!!");
	}
	public void inHP(){
	...
	public void nhapdiem(){
		...
		System.out.println("Nhap diem(A, B+, B, .. ,F)");
		for(int i=0;i<sl;i++){
			System.out.println("+Nhap diem cua mon "+tenhp[i]+":");
			diemhp[i]= sc.nextLine();
		}
		System.out.println("Nhap diem sinh vien thanh cong!!!");
	}
	public int diemf(){
		for(int i=0;i<sl;i++){
